...
# Standardise variables using scale() buit-in function
...
```
The means of the standardised variables were all very tiny numbers and so were essentially equal to 0, and the standard deviations of the standardised variables were all equal to 1.
